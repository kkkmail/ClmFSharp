...
module ModelData = 
    ...
    let d1 (x : array<double>) xSum xSumN xSumSquaredN = 
        [|
            0.0 * x.[6] // b | synthesis: Y <-> b
            -0.0 * x.[1] // Y | synthesis: Y <-> b
            0.0 * x.[4] // B | synthesis: Y <-> B
            -0.0 * x.[1] // Y | synthesis: Y <-> B
            0.0 * x.[5] // a | synthesis: Y <-> a
            -0.0 * x.[1] // Y | synthesis: Y <-> a
    ...
    let d2 (x : array<double>) xSum xSumN xSumSquaredN = 
        [|
            4.0 * 17045.7444635482 * x.[5] * x.[51] // a + BbA | sedimentation direct: a + BbA -> 4 Z
            4.0 * 17045.7444635482 * x.[3] * x.[77] // A + bBa | sedimentation direct: A + bBa -> 4 Z
            -0.0 * x.[2] // Z | destruction: b <-> Z
            0.0 * x.[6] // b | destruction: b <-> Z
            -0.0 * x.[2] // Z | destruction: B <-> Z
            0.0 * x.[4] // B | destruction: B <-> Z
    ...
    let d3 (x : array<double>) xSum xSumN xSumSquaredN = 
        [|
            -17045.7444635482 * x.[3] * x.[77] // A + bBa | sedimentation direct: A + bBa -> 4 Z
            0.0 * x.[19] // bA | ligation: b + A <-> bA
            -0.0 * x.[6] * x.[3] // b + A | ligation: b + A <-> bA
            0.0 * x.[38] // Abb | ligation: A + bb <-> Abb
            -0.0 * x.[3] * x.[22] // A + bb | ligation: A + bb <-> Abb
            0.0 * x.[37] // Aba | ligation: A + ba <-> Aba
            -0.0 * x.[3] * x.[21] // A + ba | ligation: A + ba <-> Aba
            0.0 * x.[36] // AbB | ligation: A + bB <-> AbB
            -0.0 * x.[3] * x.[20] // A + bB | ligation: A + bB <-> AbB
            0.0 * x.[35] // AbA | ligation: A + bA <-> AbA
            -0.0 * x.[3] * x.[19] // A + bA | ligation: A + bA <-> AbA
            0.0 * x.[34] // Aab | ligation: A + ab <-> Aab
            -0.0 * x.[3] * x.[18] // A + ab | ligation: A + ab <-> Aab
            0.0 * x.[33] // Aaa | ligation: A + aa <-> Aaa
            -0.0 * x.[3] * x.[17] // A + aa | ligation: A + aa <-> Aaa
            0.0 * x.[32] // AaB | ligation: A + aB <-> AaB
            -0.0 * x.[3] * x.[16] // A + aB | ligation: A + aB <-> AaB
            0.0 * x.[31] // AaA | ligation: A + aA <-> AaA
            -0.0 * x.[3] * x.[15] // A + aA | ligation: A + aA <-> AaA
            0.0 * x.[30] // ABb | ligation: A + Bb <-> ABb
            -0.0 * x.[3] * x.[14] // A + Bb | ligation: A + Bb <-> ABb
            0.0 * x.[29] // ABa | ligation: A + Ba <-> ABa
            -0.0 * x.[3] * x.[13] // A + Ba | ligation: A + Ba <-> ABa
            0.0 * x.[28] // ABB | ligation: A + BB <-> ABB
            -0.0 * x.[3] * x.[12] // A + BB | ligation: A + BB <-> ABB
            0.0 * x.[27] // ABA | ligation: A + BA <-> ABA
            -0.0 * x.[3] * x.[11] // A + BA | ligation: A + BA <-> ABA
            0.0 * x.[26] // AAb | ligation: A + Ab <-> AAb
            -0.0 * x.[3] * x.[10] // A + Ab | ligation: A + Ab <-> AAb
            0.0 * x.[25] // AAa | ligation: A + Aa <-> AAa
            -0.0 * x.[3] * x.[9] // A + Aa | ligation: A + Aa <-> AAa
            0.0 * x.[24] // AAB | ligation: A + AB <-> AAB
            -0.0 * x.[3] * x.[8] // A + AB | ligation: A + AB <-> AAB
            0.0 * x.[23] // AAA | ligation: A + AA <-> AAA
            -0.0 * x.[3] * x.[7] // A + AA | ligation: A + AA <-> AAA
            0.0 * x.[10] // Ab | ligation: A + b <-> Ab
            -0.0 * x.[3] * x.[6] // A + b | ligation: A + b <-> Ab
            0.0 * x.[15] // aA | ligation: a + A <-> aA
            -0.0 * x.[5] * x.[3] // a + A | ligation: a + A <-> aA
            0.0 * x.[9] // Aa | ligation: A + a <-> Aa
            -0.0 * x.[3] * x.[5] // A + a | ligation: A + a <-> Aa
            0.0 * x.[8] // AB | ligation: A + B <-> AB
            -0.0 * x.[3] * x.[4] // A + B | ligation: A + B <-> AB
    ...
    let d4 (x : array<double>) xSum xSumN xSumSquaredN = 
        [|
            0.0 * x.[54] // Bbb | ligation: B + bb <-> Bbb
            -0.0 * x.[4] * x.[22] // B + bb | ligation: B + bb <-> Bbb
            0.0 * x.[53] // Bba | ligation: B + ba <-> Bba
            -0.0 * x.[4] * x.[21] // B + ba | ligation: B + ba <-> Bba
            0.0 * x.[52] // BbB | ligation: B + bB <-> BbB
            -0.0 * x.[4] * x.[20] // B + bB | ligation: B + bB <-> BbB
            0.0 * x.[51] // BbA | ligation: B + bA <-> BbA
            -0.0 * x.[4] * x.[19] // B + bA | ligation: B + bA <-> BbA
            0.0 * x.[50] // Bab | ligation: B + ab <-> Bab
            -0.0 * x.[4] * x.[18] // B + ab | ligation: B + ab <-> Bab
            0.0 * x.[49] // Baa | ligation: B + aa <-> Baa
            -0.0 * x.[4] * x.[17] // B + aa | ligation: B + aa <-> Baa
            0.0 * x.[48] // BaB | ligation: B + aB <-> BaB
            -0.0 * x.[4] * x.[16] // B + aB | ligation: B + aB <-> BaB
            0.0 * x.[47] // BaA | ligation: B + aA <-> BaA
            -0.0 * x.[4] * x.[15] // B + aA | ligation: B + aA <-> BaA
            0.0 * x.[46] // BBb | ligation: B + Bb <-> BBb
            -0.0 * x.[4] * x.[14] // B + Bb | ligation: B + Bb <-> BBb
            0.0 * x.[45] // BBa | ligation: B + Ba <-> BBa
            -0.0 * x.[4] * x.[13] // B + Ba | ligation: B + Ba <-> BBa
            0.0 * x.[44] // BBB | ligation: B + BB <-> BBB
            -0.0 * x.[4] * x.[12] // B + BB | ligation: B + BB <-> BBB
            0.0 * x.[43] // BBA | ligation: B + BA <-> BBA
            -0.0 * x.[4] * x.[11] // B + BA | ligation: B + BA <-> BBA
            0.0 * x.[42] // BAb | ligation: B + Ab <-> BAb
            -0.0 * x.[4] * x.[10] // B + Ab | ligation: B + Ab <-> BAb
            0.0 * x.[41] // BAa | ligation: B + Aa <-> BAa
            -0.0 * x.[4] * x.[9] // B + Aa | ligation: B + Aa <-> BAa
            0.0 * x.[40] // BAB | ligation: B + AB <-> BAB
            -0.0 * x.[4] * x.[8] // B + AB | ligation: B + AB <-> BAB
            0.0 * x.[39] // BAA | ligation: B + AA <-> BAA
            -0.0 * x.[4] * x.[7] // B + AA | ligation: B + AA <-> BAA
            0.0 * x.[20] // bB | ligation: b + B <-> bB
            -0.0 * x.[6] * x.[4] // b + B | ligation: b + B <-> bB
            0.0 * x.[14] // Bb | ligation: B + b <-> Bb
            -0.0 * x.[4] * x.[6] // B + b | ligation: B + b <-> Bb
            0.0 * x.[13] // Ba | ligation: B + a <-> Ba
            -0.0 * x.[4] * x.[5] // B + a | ligation: B + a <-> Ba
            0.0 * x.[12] // BB | ligation: B + B <-> BB
            0.0 * x.[12] // BB | ligation: B + B <-> BB
            -0.0 * x.[4] * x.[4] // B + B | ligation: B + B <-> BB
            -0.0 * x.[4] * x.[4] // B + B | ligation: B + B <-> BB
            0.0 * x.[16] // aB | ligation: a + B <-> aB
            -0.0 * x.[5] * x.[4] // a + B | ligation: a + B <-> aB
            0.0 * x.[8] // AB | ligation: A + B <-> AB
            -0.0 * x.[3] * x.[4] // A + B | ligation: A + B <-> AB
            0.0 * x.[2] // Z | destruction: B <-> Z
            -0.0 * x.[4] // B | destruction: B <-> Z
    ...
    let d5 (x : array<double>) xSum xSumN xSumSquaredN = 
        [|
            -17045.7444635482 * x.[5] * x.[51] // a + BbA | sedimentation direct: a + BbA -> 4 Z
            0.0 * x.[13] // Ba | ligation: B + a <-> Ba
            -0.0 * x.[4] * x.[5] // B + a | ligation: B + a <-> Ba
            0.0 * x.[60] // aBB | ligation: a + BB <-> aBB
            -0.0 * x.[5] * x.[12] // a + BB | ligation: a + BB <-> aBB
            0.0 * x.[59] // aBA | ligation: a + BA <-> aBA
            -0.0 * x.[5] * x.[11] // a + BA | ligation: a + BA <-> aBA
            0.0 * x.[62] // aBb | ligation: a + Bb <-> aBb
            -0.0 * x.[5] * x.[14] // a + Bb | ligation: a + Bb <-> aBb
            0.0 * x.[61] // aBa | ligation: a + Ba <-> aBa
            -0.0 * x.[5] * x.[13] // a + Ba | ligation: a + Ba <-> aBa
            0.0 * x.[56] // aAB | ligation: a + AB <-> aAB
            -0.0 * x.[5] * x.[8] // a + AB | ligation: a + AB <-> aAB
            0.0 * x.[55] // aAA | ligation: a + AA <-> aAA
            -0.0 * x.[5] * x.[7] // a + AA | ligation: a + AA <-> aAA
            0.0 * x.[58] // aAb | ligation: a + Ab <-> aAb
            -0.0 * x.[5] * x.[10] // a + Ab | ligation: a + Ab <-> aAb
            0.0 * x.[57] // aAa | ligation: a + Aa <-> aAa
            -0.0 * x.[5] * x.[9] // a + Aa | ligation: a + Aa <-> aAa
            0.0 * x.[68] // abB | ligation: a + bB <-> abB
            -0.0 * x.[5] * x.[20] // a + bB | ligation: a + bB <-> abB
            0.0 * x.[67] // abA | ligation: a + bA <-> abA
            -0.0 * x.[5] * x.[19] // a + bA | ligation: a + bA <-> abA
            0.0 * x.[70] // abb | ligation: a + bb <-> abb
            -0.0 * x.[5] * x.[22] // a + bb | ligation: a + bb <-> abb
            0.0 * x.[69] // aba | ligation: a + ba <-> aba
            -0.0 * x.[5] * x.[21] // a + ba | ligation: a + ba <-> aba
            0.0 * x.[64] // aaB | ligation: a + aB <-> aaB
            -0.0 * x.[5] * x.[16] // a + aB | ligation: a + aB <-> aaB
            0.0 * x.[63] // aaA | ligation: a + aA <-> aaA
            -0.0 * x.[5] * x.[15] // a + aA | ligation: a + aA <-> aaA
            0.0 * x.[66] // aab | ligation: a + ab <-> aab
            -0.0 * x.[5] * x.[18] // a + ab | ligation: a + ab <-> aab
            0.0 * x.[65] // aaa | ligation: a + aa <-> aaa
            -0.0 * x.[5] * x.[17] // a + aa | ligation: a + aa <-> aaa
            0.0 * x.[16] // aB | ligation: a + B <-> aB
            -0.0 * x.[5] * x.[4] // a + B | ligation: a + B <-> aB
            0.0 * x.[15] // aA | ligation: a + A <-> aA
            -0.0 * x.[5] * x.[3] // a + A | ligation: a + A <-> aA
            0.0 * x.[9] // Aa | ligation: A + a <-> Aa
            -0.0 * x.[3] * x.[5] // A + a | ligation: A + a <-> Aa
            0.0 * x.[18] // ab | ligation: a + b <-> ab
            -0.0 * x.[5] * x.[6] // a + b | ligation: a + b <-> ab
    ...
    let d6 (x : array<double>) xSum xSumN xSumSquaredN = 
        [|
            0.0 * x.[76] // bBB | ligation: b + BB <-> bBB
            -0.0 * x.[6] * x.[12] // b + BB | ligation: b + BB <-> bBB
            0.0 * x.[75] // bBA | ligation: b + BA <-> bBA
            -0.0 * x.[6] * x.[11] // b + BA | ligation: b + BA <-> bBA
            0.0 * x.[78] // bBb | ligation: b + Bb <-> bBb
            -0.0 * x.[6] * x.[14] // b + Bb | ligation: b + Bb <-> bBb
            0.0 * x.[77] // bBa | ligation: b + Ba <-> bBa
            -0.0 * x.[6] * x.[13] // b + Ba | ligation: b + Ba <-> bBa
            0.0 * x.[72] // bAB | ligation: b + AB <-> bAB
            -0.0 * x.[6] * x.[8] // b + AB | ligation: b + AB <-> bAB
            0.0 * x.[71] // bAA | ligation: b + AA <-> bAA
            -0.0 * x.[6] * x.[7] // b + AA | ligation: b + AA <-> bAA
            0.0 * x.[74] // bAb | ligation: b + Ab <-> bAb
            -0.0 * x.[6] * x.[10] // b + Ab | ligation: b + Ab <-> bAb
            0.0 * x.[73] // bAa | ligation: b + Aa <-> bAa
            -0.0 * x.[6] * x.[9] // b + Aa | ligation: b + Aa <-> bAa
            0.0 * x.[84] // bbB | ligation: b + bB <-> bbB
            -0.0 * x.[6] * x.[20] // b + bB | ligation: b + bB <-> bbB
            0.0 * x.[83] // bbA | ligation: b + bA <-> bbA
            -0.0 * x.[6] * x.[19] // b + bA | ligation: b + bA <-> bbA
            0.0 * x.[86] // bbb | ligation: b + bb <-> bbb
            -0.0 * x.[6] * x.[22] // b + bb | ligation: b + bb <-> bbb
            0.0 * x.[85] // bba | ligation: b + ba <-> bba
            -0.0 * x.[6] * x.[21] // b + ba | ligation: b + ba <-> bba
            0.0 * x.[80] // baB | ligation: b + aB <-> baB
            -0.0 * x.[6] * x.[16] // b + aB | ligation: b + aB <-> baB
            0.0 * x.[79] // baA | ligation: b + aA <-> baA
            -0.0 * x.[6] * x.[15] // b + aA | ligation: b + aA <-> baA
            0.0 * x.[82] // bab | ligation: b + ab <-> bab
            -0.0 * x.[6] * x.[18] // b + ab | ligation: b + ab <-> bab
            0.0 * x.[81] // baa | ligation: b + aa <-> baa
            -0.0 * x.[6] * x.[17] // b + aa | ligation: b + aa <-> baa
            0.0 * x.[20] // bB | ligation: b + B <-> bB
            -0.0 * x.[6] * x.[4] // b + B | ligation: b + B <-> bB
            0.0 * x.[14] // Bb | ligation: B + b <-> Bb
            -0.0 * x.[4] * x.[6] // B + b | ligation: B + b <-> Bb
            0.0 * x.[19] // bA | ligation: b + A <-> bA
            -0.0 * x.[6] * x.[3] // b + A | ligation: b + A <-> bA
            0.0 * x.[22] // bb | ligation: b + b <-> bb
            0.0 * x.[22] // bb | ligation: b + b <-> bb
            -0.0 * x.[6] * x.[6] // b + b | ligation: b + b <-> bb
            -0.0 * x.[6] * x.[6] // b + b | ligation: b + b <-> bb
            0.0 * x.[10] // Ab | ligation: A + b <-> Ab
            -0.0 * x.[3] * x.[6] // A + b | ligation: A + b <-> Ab
            0.0 * x.[18] // ab | ligation: a + b <-> ab
            ...
            modelDataParams = 
                {
                    ...
                    allParams = 
                        [
                            {
                                synthesisDistribution = DeltaDistribution(1771124820, { threshold = None; scale = None; shift = None }) |> Delta
...

                            {
                                catSynthRndEeParams = 
                                {
                                    rateMultiplierDistr = TriangularDistribution(569898482, { threshold = Some 0.002; scale = Some 10000.0; shift = None }) |> Triangular |> RateMultDistr
                                    eeForwardDistribution = SymmetricTriangularDistribution(1078836715, { threshold = None; scale = None; shift = None }) |> SymmetricTriangular |> EeDistribution |> Some
                                    eeBackwardDistribution = SymmetricTriangularDistribution(428410852, { threshold = None; scale = None; shift = None }) |> SymmetricTriangular |> EeDistribution |> Some
                                }
                            }
                            |> CatSynthRndParam
                            ...
                            {
                                destructionDistribution = DeltaDistribution(2104952449, { threshold = None; scale = None; shift = None }) |> Delta
                                forwardScale = Some 0.001
                                backwardScale = Some 0.001
                            }
                            |> DestrRndParam
...

                            {
                                catDestrRndEeParams = 
                                {
                                    rateMultiplierDistr = TriangularDistribution(1010380539, { threshold = Some 0.002; scale = Some 10000.0; shift = None }) |> Triangular |> RateMultDistr
                                    eeForwardDistribution = SymmetricTriangularDistribution(1927047223, { threshold = None; scale = None; shift = None }) |> SymmetricTriangular |> EeDistribution |> Some
                                    eeBackwardDistribution = SymmetricTriangularDistribution(1987748247, { threshold = None; scale = None; shift = None }) |> SymmetricTriangular |> EeDistribution |> Some
                                }
                            }
                            |> CatDestrRndParam
...

                            {
                                ...
                                simBaseDistribution = UniformDistribution(283353138, { threshold = Some 0.3; scale = None; shift = None }) |> Uniform
                            ...
                            {
                                aminoAcids = AminoAcid.getAminoAcids NumberOfAminoAcids.TwoAminoAcids
                                simBaseDistribution = UniformDistribution(1805353739, { threshold = Some 0.3; scale = None; shift = None }) |> Uniform
                                getRateMultiplierDistr = DeltaRateMultDistrGetter
                                getForwardEeDistr = DeltaEeDistributionGetter
                                getBackwardEeDistr = DeltaEeDistributionGetter
                            }
                            ...
                            {
                                ligationDistribution = DeltaDistribution(1667996887, { threshold = None; scale = None; shift = None }) |> Delta
                            ...
                            {
                                sedimentationDirectDistribution = TriangularDistribution(480698291, { threshold = Some 1E-05; scale = None; shift = None }) |> Triangular
