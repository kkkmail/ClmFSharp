...
module Defaults_000_008 =

    let clmDefaultValueId = 000_008L |> ClmDefaultValueId
    ...
    let defaultRateParams =
        ...
        let catDestrParam = ReactionRateProviderParams.defaultCatDestrSimParam catDestrRndParam (Some 0.35) catRateGenType
        //===========================================================
