...
module Defaults_010 =
    ...
    let description = "Decreased defaultCatDestrSimModel -> simThreshold to 0.45 in comparision to Defaults_001."
    ...
    let getDefaultRateModels (rnd : Random) numberOfAminoAcids =
        ...
        let catDestrModel = ReactionRateProvider.defaultCatDestrSimModel rnd catDestrRndParams (Some 0.45, numberOfAminoAcids)
        //===========================================================
