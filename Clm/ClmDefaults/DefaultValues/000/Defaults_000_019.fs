...
module Defaults_000_019 =

    let clmDefaultValueId = 000_019L |> ClmDefaultValueId
    ...
    let defaultRateParams =
        ...
        let catDestrParam = ReactionRateProviderParams.defaultCatDestrSimParam catDestrRndParam (Some 0.90) catRateGenType
        //===========================================================
