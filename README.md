# ClmFSharp
## F# modelling of chiral symmetry breaking in chemical systems. Version 4.0.0.4.
...
### File Storage
File storage is used instead of SQL by worker nodes because it is assumed that worker nodes may not have SQL server installed. It stores the data in JSON files.
