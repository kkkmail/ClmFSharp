...
module Defaults_008 =
    ...
    let description = "Decreased defaultCatDestrSimModel -> simThreshold to 0.15 in comparision to Defaults_001."
    ...
    let getDefaultRateModels (rnd : Random) numberOfAminoAcids =
        ...
        let catDestrModel = ReactionRateProvider.defaultCatDestrSimModel rnd catDestrRndParams (Some 0.15, numberOfAminoAcids)
        //===========================================================
