# ClmFSharp
## F# modelling of chiral symmetry breaking in chemical systems. Version 5.0.0.3.
...
1.	Look up the value of `ClmSys.GeneralData.ClmBaseName` (e.g. `clm5003`) / adjust it as necessary.
