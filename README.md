...
1.	Look up the values of `ClmSys.VersionInfo.ClmBaseName` and `ClmSys.VersionInfo.MsgSvcBaseName` (e.g. `clm600`, `msg600`) / adjust it as necessary. They must match the values `from DbData\db.config`.
