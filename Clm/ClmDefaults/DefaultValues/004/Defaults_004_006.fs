...
module Defaults_004_006 =

    let clmDefaultValueId = 004_006L |> ClmDefaultValueId
    ...
    let defaultRateParams =
        ...
        let catSynthParam = ReactionRateProviderParams.defaultCatSynthSimParam catSynthRndParam (Some 0.05) catRateGenType
        //===========================================================
