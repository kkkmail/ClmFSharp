...
module Defaults_002_000_118 =
    ...
    let getDefaultValue (n, s) =
        let clmDefaultValueId = (2_000_118_000L + n) |> ClmDefaultValueId
        ...
        let defaultRateParams =
            //===========================================================
            let wasteRecyclingParam = ReactionRateProviderParams.defaultWasteRecyclingParam 0.2
            //===========================================================
