...
module Defaults_004_020 =

    let clmDefaultValueId = 004_020L |> ClmDefaultValueId
    ...
    let defaultRateParams =
        ...
        let catSynthParam = ReactionRateProviderParams.defaultCatSynthSimParam catSynthRndParam (Some 0.95) catRateGenType
        //===========================================================
