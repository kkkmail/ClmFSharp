...
module Defaults_004_016 =

    let clmDefaultValueId = 004_016L |> ClmDefaultValueId
    ...
    let defaultRateParams =
        ...
        let catSynthParam = ReactionRateProviderParams.defaultCatSynthSimParam catSynthRndParam (Some 0.75) catRateGenType
        //===========================================================
