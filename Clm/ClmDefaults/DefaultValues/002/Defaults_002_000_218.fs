...
module Defaults_002_000_218 =
    ...
    let getGefaultValue (n, s) =
        let clmDefaultValueId = (2_000_218_000L + n) |> ClmDefaultValueId
        ...
        let defaultRateParams =
            //===========================================================
            let wasteRecyclingParam = ReactionRateProviderParams.defaultWasteRecyclingParam 0.5
            //===========================================================
