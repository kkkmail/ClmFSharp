...
module Defaults_009 =
    ...
    let description = "Decreased defaultCatDestrSimModel -> simThreshold to 0.40 in comparision to Defaults_001."
    ...
    let getDefaultRateModels (rnd : Random) numberOfAminoAcids =
        ...
        let catDestrModel = ReactionRateProvider.defaultCatDestrSimModel rnd catDestrRndParams (Some 0.40, numberOfAminoAcids)
        //===========================================================
