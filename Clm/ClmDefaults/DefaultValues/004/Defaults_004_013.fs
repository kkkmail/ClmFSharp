...
module Defaults_004_013 =

    let clmDefaultValueId = 004_013L |> ClmDefaultValueId
    ...
    let defaultRateParams =
        ...
        let catSynthParam = ReactionRateProviderParams.defaultCatSynthSimParam catSynthRndParam (Some 0.60) catRateGenType
        //===========================================================
