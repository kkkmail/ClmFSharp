...
module Defaults_004_010 =

    let clmDefaultValueId = 004_010L |> ClmDefaultValueId
    ...
    let defaultRateParams =
        ...
        let catSynthParam = ReactionRateProviderParams.defaultCatSynthSimParam catSynthRndParam (Some 0.45) catRateGenType
        //===========================================================
