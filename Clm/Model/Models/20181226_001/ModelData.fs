            ...
            modelDataParams = 
                {
                    ...
                    allParams = 
                        [
                            {
                                synthesisDistribution = DeltaDistribution(223932575, { threshold = None; scale = None; shift = None }) |> Delta
...

                            {
                                catSynthRndEeParams = 
                                {
                                    rateMultiplierDistr = TriangularDistribution(575213509, { threshold = Some 0.002; scale = Some 10000.0; shift = None }) |> Triangular |> RateMultDistr
                                    eeForwardDistribution = SymmetricTriangularDistribution(452907605, { threshold = None; scale = None; shift = None }) |> SymmetricTriangular |> EeDistribution |> Some
                                    eeBackwardDistribution = SymmetricTriangularDistribution(2055479726, { threshold = None; scale = None; shift = None }) |> SymmetricTriangular |> EeDistribution |> Some
                                }
                            }
                            |> CatSynthRndParam
                            ...
                            {
                                destructionDistribution = DeltaDistribution(298563536, { threshold = None; scale = None; shift = None }) |> Delta
                                forwardScale = Some 0.001
                                backwardScale = Some 0.001
                            }
                            |> DestrRndParam
...

                            {
                                catDestrRndEeParams = 
                                {
                                    rateMultiplierDistr = TriangularDistribution(1825989113, { threshold = Some 0.002; scale = Some 10000.0; shift = None }) |> Triangular |> RateMultDistr
                                    eeForwardDistribution = SymmetricTriangularDistribution(1288293900, { threshold = None; scale = None; shift = None }) |> SymmetricTriangular |> EeDistribution |> Some
                                    eeBackwardDistribution = SymmetricTriangularDistribution(496924873, { threshold = None; scale = None; shift = None }) |> SymmetricTriangular |> EeDistribution |> Some
                                }
                            }
                            |> CatDestrRndParam
...

                            {
                                ...
                                simBaseDistribution = UniformDistribution(1826375837, { threshold = Some 0.3; scale = None; shift = None }) |> Uniform
                                getRateMultiplierDistr = DefaultRateMultDistrGetter
                            ...
                            {
                                aminoAcids = AminoAcid.getAminoAcids NumberOfAminoAcids.TwoAminoAcids
                                simBaseDistribution = UniformDistribution(784141477, { threshold = Some 0.3; scale = None; shift = None }) |> Uniform
                                getRateMultiplierDistr = DefaultRateMultDistrGetter
                                getForwardEeDistr = DefaultEeDistributionGetter
                                getBackwardEeDistr = DefaultEeDistributionGetter
                            }
                            ...
                            {
                                ligationDistribution = DeltaDistribution(406982203, { threshold = None; scale = None; shift = None }) |> Delta
                            ...
                            {
                                sedimentationDirectDistribution = TriangularDistribution(579313504, { threshold = Some 1E-05; scale = None; shift = None }) |> Triangular
