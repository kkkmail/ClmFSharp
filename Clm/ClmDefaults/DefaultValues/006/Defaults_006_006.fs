...
module Defaults_006_006 =

    let clmDefaultValueId = 006_006L |> ClmDefaultValueId
    ...
    let defaultRateParams =
        ...
        //===========================================================
        let ligParam = ReactionRateProviderParams.defaultLigRndParamImpl (30.0, 30.0)
        let catLigParam = ReactionRateProviderParams.defaultCatLigRndParam (ligParam, (Some 0.000_05), 2_000.0) catRateGenType
        //===========================================================
        let sedDirRndParam = (Some 0.000_200, 300.0)
