...
module Defaults_000_014 =
    ...
    let clmDefaultValueId = 000_014L |> ClmDefaultValueId
    ...
    let defaultRateParams =
        ...
        let catDestrParam = ReactionRateProviderParams.defaultCatDestrSimParam catDestrRndParam (Some 0.65) catRateGenType
        //===========================================================
