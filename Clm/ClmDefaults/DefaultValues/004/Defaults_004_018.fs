...
module Defaults_004_018 =

    let clmDefaultValueId = 004_018L |> ClmDefaultValueId
    ...
    let defaultRateParams =
        ...
        let catSynthParam = ReactionRateProviderParams.defaultCatSynthSimParam catSynthRndParam (Some 0.85) catRateGenType
        //===========================================================
