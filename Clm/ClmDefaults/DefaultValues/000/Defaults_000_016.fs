...
module Defaults_000_016 =
    ...
    let clmDefaultValueId = 000_016L |> ClmDefaultValueId
    ...
    let defaultRateParams =
        ...
        let catDestrParam = ReactionRateProviderParams.defaultCatDestrSimParam catDestrRndParam (Some 0.75) catRateGenType
        //===========================================================
