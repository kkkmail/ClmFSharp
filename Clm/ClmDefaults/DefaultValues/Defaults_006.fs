...
module Defaults_006 =
    ...
    let description = "Decreased defaultCatDestrSimModel -> simThreshold to 0.25 in comparision to Defaults_001."
    ...
    let getDefaultRateModels (rnd : Random) numberOfAminoAcids =
        ...
        let catDestrModel = ReactionRateProvider.defaultCatDestrSimModel rnd catDestrRndParams (Some 0.25, numberOfAminoAcids)
        //===========================================================
