...
module Defaults_004_004 =

    let clmDefaultValueId = 004_004L |> ClmDefaultValueId
    ...
    let defaultRateParams =
        ...
        let catSynthParam = ReactionRateProviderParams.defaultCatSynthSimParam catSynthRndParam (Some 0.30)
        //===========================================================
