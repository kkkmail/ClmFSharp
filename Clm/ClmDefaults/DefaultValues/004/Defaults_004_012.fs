...
module Defaults_004_012 =

    let clmDefaultValueId = 004_012L |> ClmDefaultValueId
    ...
    let defaultRateParams =
        ...
        let catSynthParam = ReactionRateProviderParams.defaultCatSynthSimParam catSynthRndParam (Some 0.55) catRateGenType
        //===========================================================
