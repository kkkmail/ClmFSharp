...
module Defaults_002_010 =

    let clmDefaultValueId = 002_010L |> ClmDefaultValueId
    ...
    let defaultRateParams =
        ...
        let catDestrParam = ReactionRateProviderParams.defaultCatDestrSimParam catDestrRndParam (Some 0.25) catRateGenType
        //===========================================================
