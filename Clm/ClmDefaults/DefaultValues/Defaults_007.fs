...
module Defaults_007 =
    ...
    let description = "Decreased defaultCatDestrSimModel -> simThreshold to 0.20 in comparision to Defaults_001."
    ...
    let getDefaultRateModels (rnd : Random) numberOfAminoAcids =
        ...
        let catDestrModel = ReactionRateProvider.defaultCatDestrSimModel rnd catDestrRndParams (Some 0.20, numberOfAminoAcids)
        //===========================================================
