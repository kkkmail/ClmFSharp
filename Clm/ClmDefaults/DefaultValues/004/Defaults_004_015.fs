...
module Defaults_004_015 =

    let clmDefaultValueId = 004_015L |> ClmDefaultValueId
    ...
    let defaultRateParams =
        ...
        let catSynthParam = ReactionRateProviderParams.defaultCatSynthSimParam catSynthRndParam (Some 0.70) catRateGenType
        //===========================================================
