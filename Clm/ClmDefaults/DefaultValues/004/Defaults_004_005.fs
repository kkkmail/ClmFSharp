...
module Defaults_004_005 =

    let clmDefaultValueId = 004_005L |> ClmDefaultValueId
    ...
    let defaultRateParams =
        ...
        let catSynthParam = ReactionRateProviderParams.defaultCatSynthSimParam catSynthRndParam (Some 0.25) catRateGenType
        //===========================================================
