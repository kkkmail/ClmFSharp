...
module Defaults_000_015 =
    ...
    let clmDefaultValueId = 000_015L |> ClmDefaultValueId
    ...
    let defaultRateParams =
        ...
        let catDestrParam = ReactionRateProviderParams.defaultCatDestrSimParam catDestrRndParam (Some 0.70) catRateGenType
        //===========================================================
