...
module Defaults_000_017 =

    let clmDefaultValueId = 000_017L |> ClmDefaultValueId
    ...
    let defaultRateParams =
        ...
        let catDestrParam = ReactionRateProviderParams.defaultCatDestrSimParam catDestrRndParam (Some 0.80) catRateGenType
        //===========================================================
