            ...
            modelDataParams = 
                {
                    ...
                    allParams = 
                        [
                            ...
                            {
                                synthesisDistribution = DeltaDistribution(1270076978, { threshold = None }) |> Delta
                            ...
                            {
                                destructionDistribution = DeltaDistribution(304945643, { threshold = None }) |> Delta
                                forwardScale = Some 0.001
                                backwardScale = Some 0.001
                            }
                            |> DestrRndParam
