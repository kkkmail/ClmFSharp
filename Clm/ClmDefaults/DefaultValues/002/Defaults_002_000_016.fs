...
module Defaults_002_000_016 =
    ...
    let getGefaultValue (n, s) =
        let clmDefaultValueId = (2_000_016_000L + n) |> ClmDefaultValueId
        ...
        let defaultRateParams =
            //===========================================================
            let wasteRecyclingParam = ReactionRateProviderParams.defaultWasteRecyclingParam 1.0
            //===========================================================
