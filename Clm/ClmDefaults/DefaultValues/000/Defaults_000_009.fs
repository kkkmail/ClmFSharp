...
module Defaults_000_009 =
    ...
    let clmDefaultValueId = 000_009L |> ClmDefaultValueId
    ...
    let defaultRateParams =
        ...
        let catDestrParam = ReactionRateProviderParams.defaultCatDestrSimParam catDestrRndParam (Some 0.40) catRateGenType
        //===========================================================
