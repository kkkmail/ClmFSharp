...
module Defaults_004_003 =

    let clmDefaultValueId = 004_003L |> ClmDefaultValueId
    ...
    let defaultRateParams =
        ...
        let catSynthParam = ReactionRateProviderParams.defaultCatSynthSimParam catSynthRndParam (Some 0.15) catRateGenType
        //===========================================================
