            ...
            modelDataParams = 
                {
                    ...
                    allParams = 
                        [
                            {
                                wasteRecyclingRate = 10.0
                            }
                            |> WasteRecyclingRateParam

                            {
                                synthesisDistribution = DeltaDistribution(1004701872, { threshold = None }) |> Delta
                            ...
                            {
                                destructionDistribution = DeltaDistribution(1454859318, { threshold = None }) |> Delta
                                forwardScale = Some 0.001
                                backwardScale = Some 0.001
                            }
                            |> DestrRndParam
                            ...
                            {
                                ligationDistribution = DeltaDistribution(1812824130, { threshold = None }) |> Delta
