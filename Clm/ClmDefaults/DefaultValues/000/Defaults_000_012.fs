...
module Defaults_000_012 =
    ...
    let clmDefaultValueId = 000_012L |> ClmDefaultValueId
    ...
    let defaultRateParams =
        ...
        let catDestrParam = ReactionRateProviderParams.defaultCatDestrSimParam catDestrRndParam (Some 0.55) catRateGenType
        //===========================================================
