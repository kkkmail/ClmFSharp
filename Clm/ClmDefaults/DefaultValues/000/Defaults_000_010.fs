...
module Defaults_000_010 =

    let clmDefaultValueId = 000_010L |> ClmDefaultValueId
    ...
    let defaultRateParams =
        ...
        let catDestrParam = ReactionRateProviderParams.defaultCatDestrSimParam catDestrRndParam (Some 0.45) catRateGenType
        //===========================================================
