...
module Defaults_004_007 =

    let clmDefaultValueId = 004_007L |> ClmDefaultValueId
    ...
    let defaultRateParams =
        ...
        let catSynthParam = ReactionRateProviderParams.defaultCatSynthSimParam catSynthRndParam (Some 0.10) catRateGenType
        //===========================================================
