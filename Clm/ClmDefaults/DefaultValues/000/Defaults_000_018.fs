...
module Defaults_000_018 =

    let clmDefaultValueId = 000_018L |> ClmDefaultValueId
    ...
    let defaultRateParams =
        ...
        let catDestrParam = ReactionRateProviderParams.defaultCatDestrSimParam catDestrRndParam (Some 0.85) catRateGenType
        //===========================================================
