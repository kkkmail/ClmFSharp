...
module Defaults_002_013 =

    let clmDefaultValueId = 002_013L |> ClmDefaultValueId
    ...
    let defaultRateParams =
        ...
        let catDestrParam = ReactionRateProviderParams.defaultCatDestrSimParam catDestrRndParam (Some 0.30) catRateGenType
        //===========================================================
