            ...
            modelDataParams = 
                {
                    ...
                    allParams = 
                        [
                            {
                                synthesisDistribution = DeltaDistribution(1655720338, { threshold = None }) |> Delta
                            ...
                            {
                                ligationDistribution = DeltaDistribution(1809457840, { threshold = None }) |> Delta
                                forwardScale = Some 0.001
                                backwardScale = Some 0.0001
                            }
                            |> LigationRateParam
                            ...
                            {
                                catSynthDistribution = TriangularDistribution(862549316, { threshold = Some 0.0005 }) |> Triangular
                                multiplier = 1000.0
                                maxEe = 0.05
                            }
                            ...
                            {
                                catLigationDistribution = TriangularDistribution(2093756683, { threshold = Some 0.0001 }) |> Triangular
                                multiplier = 1000.0
                                maxEe = 0.05
                            }
                            ...
                            {
                                sedimentationDirectDistribution = TriangularDistribution(894557167, { threshold = Some 0.0001 }) |> Triangular
