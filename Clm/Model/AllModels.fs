        ...
        [
            {
                modelInfo = 
                    {
                        fileStructureVersionNumber = "1.0.0.0"
                        versionNumber = "1.0.1.3"
                        seedValue = 1608209342
                        modelName = "20181203_005"
                        numberOfSubstances = 6175
                        numberOfAminoAcids = NumberOfAminoAcids.NineAminoAcids
                        maxPeptideLength = MaxPeptideLength.ThreeMax
                    }
                ...
                allParams = 
                    [
                        {
                            synthesisDistribution = DeltaDistribution(1079093307, { threshold = None }) |> Delta
                            forwardScale = Some 0.001
                            backwardScale = Some 0.0001
                        }
                        |> SynthesisRateParam
                        ...
                        {
                            ligationDistribution = DeltaDistribution(1594259816, { threshold = None }) |> Delta
                            forwardScale = Some 0.001
                            backwardScale = Some 0.0001
                        }
                        |> LigationRateParam
                        ...
                        {
                            catSynthDistribution = TriangularDistribution(2147221232, { threshold = Some 0.0005 }) |> Triangular
                            multiplier = 1000.0
                            maxEe = 0.05
                        }
                        |> CatalyticSynthesisRateParam
                        ...
                        {
                            catLigationDistribution = TriangularDistribution(1094211452, { threshold = Some 0.0001 }) |> Triangular
                            multiplier = 1000.0
                            maxEe = 0.05
                        }
                        |> CatalyticLigationRateParam
                        ...
                        {
                            sedimentationDirectDistribution = TriangularDistribution(1453008087, { threshold = Some 0.0001 }) |> Triangular
                            forwardScale = Some 1000.0
                        }
                        |> SedimentationDirectRateParam
                ...
                modelInfo = 
                    {
                        ...
                        seedValue = 1213832326
                        modelName = "20181204_003"
                        numberOfSubstances = 4681
                        numberOfAminoAcids = NumberOfAminoAcids.FourAminoAcids
                        maxPeptideLength = MaxPeptideLength.FourMax
                    }

                allParams = 
                    [
                        {
                            synthesisDistribution = DeltaDistribution(20871995, { threshold = None }) |> Delta
                            forwardScale = Some 0.001
                            backwardScale = Some 0.0001
                        }
                        |> SynthesisRateParam
                        ...
                        {
                            ligationDistribution = DeltaDistribution(1929239561, { threshold = None }) |> Delta
                            forwardScale = Some 0.001
                            backwardScale = Some 0.0001
                        }
                        |> LigationRateParam
                        ...
                        {
                            catSynthDistribution = TriangularDistribution(205068433, { threshold = Some 0.0005 }) |> Triangular
                            multiplier = 1000.0
                            maxEe = 0.05
                        }
                        |> CatalyticSynthesisRateParam
                        ...
                        {
                            catLigationDistribution = TriangularDistribution(985585146, { threshold = Some 0.0001 }) |> Triangular
                            multiplier = 1000.0
                            maxEe = 0.05
                        }
                        |> CatalyticLigationRateParam
                        ...
                        {
                            sedimentationDirectDistribution = TriangularDistribution(1849754752, { threshold = Some 0.0001 }) |> Triangular
                            forwardScale = Some 1000.0
                        }
                        |> SedimentationDirectRateParam
