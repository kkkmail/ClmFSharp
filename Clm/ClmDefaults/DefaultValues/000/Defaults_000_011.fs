...
module Defaults_000_011 =

    let clmDefaultValueId = 000_011L |> ClmDefaultValueId
    ...
    let defaultRateParams =
        ...
        let catDestrParam = ReactionRateProviderParams.defaultCatDestrSimParam catDestrRndParam (Some 0.50) catRateGenType
        //===========================================================
