...
module Defaults_004_002 =

    let clmDefaultValueId = 004_002L |> ClmDefaultValueId
    ...
    let defaultRateParams =
        ...
        let catSynthRndParam = (synthParam, (Some 0.000_015), 100_000.0)
        //let catSynthParam = ReactionRateProviderParams.defaultCatSynthRndParam catSynthRndParam
        let catSynthParam = ReactionRateProviderParams.defaultCatSynthSimParam catSynthRndParam (Some 0.20)
        //===========================================================
