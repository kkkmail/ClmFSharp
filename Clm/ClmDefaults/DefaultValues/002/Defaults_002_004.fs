...
module Defaults_002_004 =

    let clmDefaultValueId = 002_004L |> ClmDefaultValueId
    ...
    let defaultRateParams =
        ...
        let catDestrRndParam = (destrParam, (Some 0.000_003), 100_000.0)
        //let catDestrParam = ReactionRateProviderParams.defaultCatDestrRndParam catDestrRndParam catRateGenType
        let catDestrParam = ReactionRateProviderParams.defaultCatDestrSimParam catDestrRndParam (Some 0.10) catRateGenType
        //===========================================================
