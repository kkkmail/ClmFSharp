...
module Defaults_003_000_116 =
    ...
    let getGefaultValue (n, s) =
        let clmDefaultValueId = (3_000_116_000L + n) |> ClmDefaultValueId
        ...
        let defaultRateParams =
            //===========================================================
            let wasteRecyclingParam = ReactionRateProviderParams.defaultWasteRecyclingParam 2.0
            //===========================================================
